...
{
      15,     0,    -1,    -1,    15,    17,     7,    -1,    15,     1,
       7,    -1,     7,    -1,    -1,     4,     6,     3,    -1,     4,
       6,     5,    -1,    -1,     8,     9,     4,    10,    12,    16,
      -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "WORD", "STR", "EQUAL", "EOL",
  "CHOOSE", "SHEET", "SELECT", "ALL", "WHERE", "QUOTE", "$accept", "app",
  "predicate", "exp", 0
};
#endif
...
#line 60 "parser.y"
  ...
  case 10:
#line 66 "parser.y"
    { (yyval.qval) = form_query((yyvsp[(3) - (6)].strval), (yyvsp[(6) - (6)].pval)); ;}
    break;
